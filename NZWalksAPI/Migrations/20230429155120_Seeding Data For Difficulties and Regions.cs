    ...
    public partial class SeedingDataForDifficultiesandRegions : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("21257f08-c7bd-4e77-bacf-fb413e0fc089"), "Easy" },
                    { new Guid("275cd27e-1d81-40f4-b68f-83a4725a96d8"), "Hard" },
                    { new Guid("d3a0ef97-833e-4252-9d0f-356a06f4414a"), "Medium" }
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("21257f08-c7bd-4e77-bacf-fb413e0fc089"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("275cd27e-1d81-40f4-b68f-83a4725a96d8"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("d3a0ef97-833e-4252-9d0f-356a06f4414a"));
